...
from mar3d.utils.callbacks import (
    CodeSnapshotCallback,
    ConfigSnapshotCallback,
    CustomProgressBar,
    ProgressCallback,
)
from mar3d.utils.config import ExperimentConfig, load_config
from mar3d.utils.misc import get_rank
from mar3d.utils.typing import Optional
...
def main(args, extras) -> None:
    ...
    if args.typecheck:
        ...
        install_import_hook("mar3d", "typeguard.typechecked")
    ...
    dm = mar3d.find(cfg.data_type)(cfg.data)
    system: BaseSystem = mar3d.find(cfg.system_type)(
